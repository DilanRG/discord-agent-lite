...
def _cases() -> tuple[ExtractorCase, ...]:
    cases = (
        ...
        ExtractorCase("pdf-signature", "notes.pdf", "application/pdf", b"%PDF-1.7", expected_kind="pdf"),
        ExtractorCase("docx-signature", "notes.docx", "application/octet-stream", b"PK\x03\x04docx", expected_kind="docx"),
